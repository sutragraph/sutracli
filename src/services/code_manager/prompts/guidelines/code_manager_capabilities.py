...
Comprehensive capabilities for connection code extraction and output format generation.
"""
...
1. You have access to tool results from cross-indexing analysis that contain connection patterns, code snippets, and file information. Your role is to analyze these results and determine what code should be extracted and returned in proper XML output format.
...
5. You can analyze package information and connection technologies used in projects:
...
6. You understand language-specific connection patterns that may not appear in dependency files:
...
7. You can identify and analyze custom wrapper functions that abstract connection logic:
...
10. You can determine storage priority based on connection identifier types:
...
11. You can generate proper XML output format with complete file paths, line ranges, and descriptive context for each connection code snippet that needs to be extracted.
"""
