                        ...
                        if mapped:
                            ...
                            for j, mapped_conn in enumerate(mapped, 1):
                                ...
                                if mapped_conn.get("outgoing_code_snippet"):
                                    mapped_snippet = mapped_conn["outgoing_code_snippet"][:80] + "..." if len(mapped_conn["outgoing_code_snippet"]) > 80 else mapped_conn["outgoing_code_snippet"]
                        ...
                        if mapped:
                            ...
                            for j, mapped_conn in enumerate(mapped, 1):
                                ...
                                if mapped_conn.get("incoming_code_snippet"):
                                    mapped_snippet = mapped_conn["incoming_code_snippet"][:80] + "..." if len(mapped_conn["incoming_code_snippet"]) > 80 else mapped_conn["incoming_code_snippet"]
                                    output_parts.append(f"          Code: {mapped_snippet}")
