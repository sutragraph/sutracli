...
# from services.cross_indexing.task_filter.prompts.task_filter_prompt_manager import (
#     TaskFilterPromptManager,
# )
...
#                 user_prompt = self.prompt_manager.get_user_prompt(task_list, phase_info)
