...
Defines the rules and guidelines for task filtering operations.
"""

TASK_FILTER_RULES = """# Task Filtering Rules
...
1. **Use Sutra Memory Format**: All output must use proper Sutra memory XML format
